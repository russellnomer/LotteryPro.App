...
export class LotteryDataService {
  ...
  private readonly MINIMUM_SAMPLE_SIZE = 30; // Statistically significant sample
  private readonly MAXIMUM_SAMPLE_SIZE = 100; // Performance optimization
  ...
  private generateRealisticCurrentResults(game: 'powerball' | 'megamillions'): LotteryApiResponse[] {
    ...
    // Generate results for the last 30 draws (about 3 months of data)
    for (let i = 0; i < 30; i++) {
